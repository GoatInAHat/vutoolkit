...
describe("vutoolkit", () => {
  it("declares tool metadata", () => {
    expect(getToolPluginMetadata(entry)?.tools.map((tool) => tool.name)).toEqual(["gpa.verify","grades.whatif","record.fetch","sessions.forget","sessions.list","sessions.open","web"]);
  });
